...
class CadastroController extends GetxController {
  ...
  cadastro() {
    var parametro = {'name': usuarioController.value.text, 'email': emailController.value.text, 'password': senhaController.value.text};
    Api api = Api();
    api.store(parametro).then((result) async {
